                            ...
                            <div className="offset-md-2 col-md-8 col-sm-12">
                                <div className="slider">
                                    <div className="slider-item">
                                        <div className="test-img"><img src="images/user1.jpg" alt="Placeholder" width="157" height="157"></img></div>
                                    ...
                                    <div className="slider-item">
                                        <div className="test-img"><img src="images/user3.jpg" alt="Placeholder" width="157" height="157"></img></div>
